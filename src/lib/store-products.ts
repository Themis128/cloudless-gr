...
export const demoProducts: StoreProduct[] = [
  ...
  {
    id: "srv-growth",
    name: "AI Growth Engine",    description:
  ...
  // --- Digital Products ---
  {
    ...
    features: [
      "120+ page PDF guide",
      "Terraform templates",      "Cost calculator spreadsheet",
      "Migration checklist",
      "Lifetime updates",
    ],
  },
  ...
  },
  {
    ...
    price: 9900,
    currency: "eur",
    category: "digital",    image: "/store/serverless-course.svg",
    features: [
      "40+ video lessons",
      "Hands-on projects",
  ...
  {
    id: "phy-tshirt",
    name: "Cloudless T-Shirt",    description:
...
export const categoryColors: Record<ProductCategory, string> = {
  service: "bg-electric/10 text-electric",
  digital: "bg-cyan/10 text-cyan",
  physical: "bg-emerald-500/10 text-emerald-600",
};