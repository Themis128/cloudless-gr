      ...
      <section className="relative overflow-hidden bg-navy text-white">
        ...
        <div className="relative mx-auto max-w-6xl px-6 py-24 md:py-32 lg:py-40">
          <div className="max-w-2xl">
            <p className="text-cyan font-mono text-sm font-medium tracking-wide mb-4">
            ...
            </h1>            <p className="mt-6 text-lg md:text-xl text-slate-300 leading-relaxed max-w-xl">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              <Link
                href="/contact"
                className="bg-electric hover:bg-electric-dark text-white font-semibold px-8 py-3.5 rounded-lg transition-colors text-center"
              >
                Get a Free Audit
              </Link>
              <Link
                href="/services"
                className="border border-slate-500 hover:border-electric text-white font-semibold px-8 py-3.5 rounded-lg transition-colors text-center"
              >
                View Services
              </Link>
            </div>
            ...
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <div className="text-3xl font-heading font-bold text-electric">
                  {stat.value}
                </div>                <div className="mt-1 text-sm text-muted">{stat.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {services.map((service) => (
              <div
                key={service.title}
                className="group p-8 rounded-2xl border border-slate-200 hover:border-electric/30 hover:shadow-lg hover:shadow-electric/5 transition-all duration-300"
              >
                <div className="text-3xl mb-4">{service.icon}</div>                <h3 className="text-xl font-heading font-semibold text-navy group-hover:text-electric transition-colors">
                  {service.title}
                </h3>
          ...
          <div className="text-center mt-12">
            <Link
              href="/services"
              className="text-electric hover:text-electric-dark font-semibold inline-flex items-center gap-2 transition-colors"
            >
              See pricing & details
      ...
      <section className="bg-navy text-white">
        <div className="mx-auto max-w-6xl px-6 py-20 md:py-24 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold">
            Ready to go{" "}            <span className="bg-gradient-to-r from-electric to-cyan bg-clip-text text-transparent">
              cloudless
            </span>
            ?
          </h2>
          ...
          <Link
            href="/contact"
            className="inline-block mt-8 bg-electric hover:bg-electric-dark text-white font-semibold px-10 py-4 rounded-lg transition-colors text-lg"
          >
